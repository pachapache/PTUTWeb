...
//Permet de traitement de la connexion
...
public class traitementConnexion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String vu = "/connexion.jsp";//Echec de la connexion
        String vu_Valide = "/accueilC.jsp";//Connexion réussite
        ...
        if (mails != null & mdp != null) {
            try {
                ...
                if (connexion == true) {
                    //Création et attribution d'attributs à la session en cours
